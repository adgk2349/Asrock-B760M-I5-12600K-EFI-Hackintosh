<h1 align="center">Asrock-B760M-I5-12600K-EFI-Hackintosh </h1>
...
| Audio Recording                      | ✅   | `AppleALC.kext` with Layout ID = 13 and `SSDT-HPET.aml`   |
| Audio Playback                       | ✅   | `AppleALC.kext` with Layout ID = 13 and `SSDT-HPET.aml`   |
| Automatic Headphone Output Switching | ✅   | `AppleALC.kext` with Layout ID = 13 and `SSDT-HPET.aml`   |
| Dock Audio Port                      | ✅   | `AppleALC.kext` with Layout ID = 13 and `SSDT-HPET.aml`   |
...
| Ethernet                             | ✅   | `IntelRealtek8111.kext`  |
...
| AirDrop                              | ❌     | Physically unable to use on sonoma             |
| Time Machine                         | ✅     | Native                                         |
